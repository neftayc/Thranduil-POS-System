...
import { getExecutiveProfitability } from '../../modules/reports/app/getExecutiveProfitability'
...
export default defineEventHandler(async (event) => {
  ...
  if (rawPeriod && !periodCode) {
    throw createError({
      statusCode: 400,
      statusMessage: 'Periodo invalido. Usa recovery_2025_to_2026_03_08 o standard_from_2026_03_09.'
    })
  }

  try {
    return await getExecutiveProfitability(repo, { period_code: periodCode })
  } catch (err: any) {
